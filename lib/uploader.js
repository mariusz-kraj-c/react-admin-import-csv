...
function create(logging, disableCreateMany, dataProvider, resource, values, meta, preCommitCallback, postCommitCallback) {
...
function update(logging, disableUpdateMany, dataProvider, resource, values, meta, preCommitCallback, postCommitCallback) {
    return __awaiter(this, void 0, void 0, function () {
        var parsedValues, _a, reportItems, shouldReject;
        return __generator(this, function (_b) {
            switch (_b.label) {
...
function createInDataProvider(logging, disableCreateMany, dataProvider, resource, values, meta) {
    return __awaiter(this, void 0, void 0, function () {
