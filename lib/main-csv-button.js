...
var MainCsvImport = function (props) {
    ...
    function createRows(vals, meta) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, uploader_1.create)(logging, disableCreateMany, dataProvider, resourceName, vals, meta, preCommitCallback, postCommitCallback)];
            });
        });
    }
    function updateRows(vals, meta) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, uploader_1.update)(logging, disableUpdateMany, dataProvider, resourceName, vals, meta, preCommitCallback, postCommitCallback)];
            });
        });
    }
