...
export var MainCsvImport = function (props) {
    ...
    React.useEffect(function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 5:
                            ...
                            return [4 /*yield*/, GetIdsColliding(logging, translate, dataProvider, csvItems, resourceName, disableGetMany)];
                        case 6:
        ...
        processCSV()
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, createRows(csvItems, meta)];
                        case 1:
                            _b.sent();
    ...
    function createRows(vals, meta) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, create(logging, disableCreateMany, dataProvider, resourceName, vals, meta, preCommitCallback, postCommitCallback)];
            });
        });
    }
    function updateRows(vals, meta) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, update(logging, disableUpdateMany, dataProvider, resourceName, vals, meta, preCommitCallback, postCommitCallback)];
            });
        });
    }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, updateRows(valuesColliding, meta)];
                case 3:
                    _a.sent();
                    handleClose();
                    return [3 /*break*/, 5];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, updateRows([currentValue], meta)];
                case 1:
                    _a.sent();
                    val = nextConflicting();
                    if (!val) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    delete localCopy.id;
                    return [4 /*yield*/, createRows([localCopy], meta)];
                case 1:
                    _a.sent();
                    val = nextConflicting();
                    if (!val) {
