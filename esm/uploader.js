...
export function create(logging, disableCreateMany, dataProvider, resource, values, meta, preCommitCallback, postCommitCallback) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    parsedValues = _a;
                    return [4 /*yield*/, createInDataProvider(logging, !!disableCreateMany, dataProvider, resource, parsedValues, meta)];
                case 4:
                    reportItems = _b.sent();
...
export function update(logging, disableUpdateMany, dataProvider, resource, values, meta, preCommitCallback, postCommitCallback) {
    return __awaiter(this, void 0, void 0, function () {
        var parsedValues, _a, reportItems, shouldReject;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    parsedValues = _a;
                    return [4 /*yield*/, updateInDataProvider(logging, !!disableUpdateMany, dataProvider, resource, parsedValues, meta)];
                case 4:
                    reportItems = _b.sent();
                    if (postCommitCallback) {
                        postCommitCallback(reportItems);
...
export function createInDataProvider(logging, disableCreateMany, dataProvider, resource, values, meta) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, createInDataProviderFallback(dataProvider, resource, values, meta)];
                case 1:
                    items = _a.sent();
                ...
                case 2:
                    _a.trys.push([2, 4, , 9]);
                    return [4 /*yield*/, dataProvider.createMany(resource, { data: values, meta: meta })];
                case 3:
                    response = _a.sent();
                    reportItems.push({
...
function createInDataProviderFallback(dataProvider, resource, values, meta) {
    return __awaiter(this, void 0, void 0, function () {
        var reportItems;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
function updateInDataProvider(logging, disableUpdateMany, dataProvider, resource, values, meta) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, updateInDataProviderFallback(dataProvider, resource, values, meta)];
                case 1:
                    items = _a.sent();
                    return [2 /*return*/, items];
                case 2:
                ...
                case 3:
                    _a.trys.push([3, 5, , 10]);
                    return [4 /*yield*/, dataProvider.updateManyArray(resource, { ids: ids, data: values, meta: meta })];
                case 4:
                    response = _a.sent();
                    reportItems.push({
                        value: null, success: true, response: response
...
function updateInDataProviderFallback(dataProvider, resource, values, meta) {
    return __awaiter(this, void 0, void 0, function () {
        var reportItems;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Promise.all(values.map(function (value) {
                            return dataProvider
                                .update(resource, { id: value.id, data: value, previousData: null, meta: meta })
                                .then(function (res) {
                                return reportItems.push({ value: value, success: true, response: res });
                            })
                                .catch(function (err) { return reportItems.push({ value: value, success: false, err: err }); });
